...
sPDF <- joinCountryData2Map(dF = dataFinal,
                            joinCode = "ISO2",
...
mapCountryData(sPDF, nameColumnToPlot = "Malware")
mapCountryData(sPDF, nameColumnToPlot = "Threat")
mapCountryData(sPDF, nameColumnToPlot = "Status")
